...
using RMA.WebServer.Auditing;

namespace RMA.WebServer.EntityFrameworkCore
{
    public class RMAWebServerDbContext : AbpDbContext
    {
        /// <summary>
        /// Audit logs.
        /// </summary>
        ...
        public RMAWebServerDbContext(DbContextOptions<RMAWebServerDbContext> options) 
            : base(options)
        {
